...
const FirstAndSecond: React.FC = () => {
  ...
  const frameOpacity = useTransform(scrollYProgress, [0.196, 0.198], [0, 1]) // (ao dar scroll no eixo Y, entre 19.6% à  19.8%, a opacidade vai de 0 para 1)
  ...
  return (
    <Sticky className="second">
      ...
      <motion.div style={{
        ...
        scale: frameScale
      }}> {/* para animar uma div tem que usar motion.div */}
...
const First: React.FC = () => {
  ...
  const firstBorderRadius = useTransform(scrollYProgress,
    [0.198, 0.264, 0.558, 0.627],
    [0, 4, 4, 0]
  )
